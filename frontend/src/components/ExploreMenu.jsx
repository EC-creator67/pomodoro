...
const ExploreMenu = ({category, setCategory}) => {
  return (
    <div className='flex flex-col gap-8'id='explore-menu' >
      <h1 className='text-cyan-950 text-3xl font-semibold text-center -mb-10 mt-10'>Esplora il nostro Menu</h1>
      ...
      <div className='flex gap-6 justify-between  items-center my-6 scrollable-x-container cursor-pointer '>
      ...
      <hr className='h-1 bg-violet-300 border-none'/>
    </div>
  )
}
