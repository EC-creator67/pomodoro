...
const Header = () => {
  return (
    <div
      className="h-[30vw] my-10 mx-auto relative bg-no-repeat bg-cover"
      style={{ backgroundImage: `url(${headerImg})` }}
    >
      <div
        className="absolute flex flex-col items-start gap-2 max-w-[50%] 
        bottom-[25%] left-6 "
      >
        <h2 className="text-xl md:text-3xl italic lg:text-4xl font-semibold  text-violet-800 fade-in">
        ...
        <a
          href="#explore-menu"
          className=" py-3 px-6 text-md  lg:block bg-orange-300  rounded-md 
